...
StorageUtil.getBlobService = function(connection) {
  ...
  if (serviceSettings === null) {
    ...
    service.usePathStyleUri = utils.stringIsNullOrEmpty(serviceSettings._blobEndpoint.secondaryHost);
  }
...
StorageUtil.getTableService = function(connection) {
  ...
  if (serviceSettings === null) {
    ...
    service.usePathStyleUri = utils.stringIsNullOrEmpty(serviceSettings._tableEndpoint.secondaryHost);
  }
  return service.withFilter(new ExponentialRetryPolicyFilter());
};
...
StorageUtil.getQueueService = function(connection) {
  ...
  if (serviceSettings === null) {
    ...
    service.usePathStyleUri = utils.stringIsNullOrEmpty(serviceSettings._queueEndpoint.secondaryHost);
  }
  return service.withFilter(new ExponentialRetryPolicyFilter());
};
...
StorageUtil.getFileService = function(connectionString) {
  ...
  if (serviceSettings === null) {
    ...
    service.usePathStyleUri = utils.stringIsNullOrEmpty(serviceSettings._fileEndpoint.secondaryHost);
  }
  return service.withFilter(new ExponentialRetryPolicyFilter());
};
